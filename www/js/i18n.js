...
const I18N = {
  fr: {
    ...
    btn_play: "▶️ Jouer",
    btn_resume: (title, levelId) => `🔄 Reprendre : ${title} niveau ${levelId}`,
    btn_library: "📖 Mes versets",
    btn_help: "❓ Comment jouer ?",
    pause_title: "Partie en pause",
    btn_resume_pause: "▶️ Reprendre",
    btn_quit_pause: "🚪 Quitter",
    btn_start_level: "▶️ Commencer",
    combo_text: "Bien joué ! 🎉",
  ...
  en: {
    ...
    btn_play: "▶️ Play",
    btn_resume: (title, levelId) => `🔄 Resume: ${title} level ${levelId}`,
    btn_library: "📖 My verses",
    btn_help: "❓ How to play?",
    pause_title: "Game paused",
    btn_resume_pause: "▶️ Resume",
    btn_quit_pause: "🚪 Quit",
    btn_start_level: "▶️ Start",
    combo_text: "Nice! 🎉",
